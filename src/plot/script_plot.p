...
set term wxt title '9.745697e+10'
plot \
...
replot \
	'plot/plot_datastd_8.dat' using 1:2 with lines lc rgb "#808000" lw 2 title "Cable 9",\
	'plot/plot_datastd_8.dat' using 1:2:(0.6) with circles fill solid lc rgb "black" notitle,\
	'plot/plot_datastd_8.dat' using 1:2:3     with labels tc rgb "black" offset (0,0) font 'Arial Bold' notitle
replot \
